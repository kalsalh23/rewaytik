...
import { BookOpen, LayoutDashboard, ShoppingBag, Users, BarChart3, Settings, Image as ImageIcon, Bell, MessageSquare, ArrowLeft, Monitor } from 'lucide-react'
...
export function AdminLayout() {
  ...
  const sidebarLinks = [
    ...
    { path: '/admin/banners', label: 'الإعلانات', icon: Monitor },
